<nav class="navbar sticky-top navbar-expand-sm bg-dark">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
            <a class="nav-link text-warning" href="admin.php"><i class="fa fa-home fa-x mr-1 "></i>Home</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-warning" href="edit_product.php"><i class="fa fa-edit fa-x mr-1"></i>Edit Product details</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-warning" href="#m4" data-backdrop="static" data-toggle="modal"><i class="fa fa-plus-square fa-x mr-1"></i>Add Product</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-warning dropdown" id="admin" data-toggle="popover" data-placement="bottom" title="User profile"><i class="fa fa-user-circle fa-x mr-1"></i><?php echo $_SESSION["name"]; ?></a>
        </li>
    </ul>
</nav>
                ...
                <form action="function_db.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="custom-file col-sm-8">
                            ...
                            <label class="custom-file-label" for="customFile">Images cannot be updated</label>
                        </div>
                    </div>
                    <div class="form-group row">
